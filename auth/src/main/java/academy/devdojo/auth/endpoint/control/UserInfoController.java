package academy.devdojo.auth.endpoint.control;
...
public class UserInfoController {
    ...
    @ApiOperation(value = "Will retrieve information from the user available in the token", response = ApplicationUser.class)
